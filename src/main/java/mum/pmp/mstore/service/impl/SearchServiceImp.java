 ...
 * import mum.pmp.mstore.repository.CategoryRepository; import
 * mum.pmp.mstore.repository.ProductRepository; import
 * mum.pmp.mstore.repository.SearchRepository; import
 * mum.pmp.mstore.service.SearchService;
 * 
 * @Service public class SearchServiceImp implements SearchService {
 * 
 * @Resource private ProductRepository productRepository;
 * 
 * @Resource private CategoryRepository categoryRepository;
 * 
 * @Resource private SearchRepository searchRepository;
 * 
 * @Override public List<Category> getAllCategories() { return (List<Category>)
 * searchRepository.getAllCategories(); }
 * 
 * @Override public List<Product> getAllProducts() { return (List<Product>)
